import data.{ChebyshevDistance, EuclideanDistance}
import data.representation.{BidimensionalPoint, Cluster}
import functions.hierarchical.clustering.ClusteringAlgorithm
import functions.hierarchical.clustering.method.{AverageLinkage, CompleteLinkage, SingleLinkage}
